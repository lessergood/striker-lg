...
<div id="page" class="hfeed site">
    ...
    <div class="site-logo">
	  ...
	  <div class="right" style="margin-top: 10px;">
		Find Causes:&nbsp;<?php include('searchform.php'); ?>
		<a href="http://lessergood.org/causes">browse causes</a>
	  	</div>
<?php endif; ?>
		...
		<nav role="navigation" class="site-navigation main-navigation">
		  ...
		  <div class="account-menu-container right">
			
			<?php include(locate_template('menu.php')); ?>
			<?php //get_sidebar('account-menu'); ?>
		  </div>
	  	</nav>
