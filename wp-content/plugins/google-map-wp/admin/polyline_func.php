	...
	foreach ( $map as $map ) {
		...
		<script>
							...
							jQuery(".edit_polyline_list_delete a").on("click", function () {
								...
								for (var e = 0; e < polylines.length; e++) {
									...
									if (polylineid == id) {
										...
										google.maps.event.addListener(polylineedit, 'mouseover', function (event) {
											var polyline_line_color = "#" + jQuery('#hover_polyline_edit_line_color').val();
											var polyline_line_opacity = jQuery('#hover_polyline_edit_line_opacity').val();
											if (polylineedit) {
												polylineedit.setOptions({
													strokeColor: polyline_line_color,
													strokeOpacity: polyline_line_opacity,
										...
										google.maps.event.addListener(polylineedit, 'mouseout', function (event) {
			...
			function placePolyline(location) {
				...
				google.maps.event.addListener(newpolyline, 'mouseover', function (event) {
					var polyline_line_color = "#" + jQuery('#hover_polyline_line_color').val();
					var polyline_line_opacity = jQuery('#hover_polyline_line_opacity').val();
					if (newpolyline) {
						newpolyline.setOptions({
							strokeColor: polyline_line_color,
							strokeOpacity: polyline_line_opacity,
				...
				google.maps.event.addListener(newpolyline, 'mouseout', function (event) {
					var polyline_line_color = "#" + jQuery('#polyline_line_color').val();
					var polyline_line_opacity = jQuery('#polyline_line_opacity').val();
					var polyline_line_width = jQuery('#polyline_line_width').val();
					if (newpolyline) {
