	...
	foreach ( $map as $map ) {
		...
		<script>
			...
			jQuery(document).ready(function () {
				loadMarkerMap("<?php echo $map->id; ?>",
					"#<?php echo $map->styling_hue; ?>",
					"<?php echo $map->styling_saturation; ?>",
					"<?php echo $map->styling_lightness; ?>",
					"<?php echo $map->styling_gamma; ?>",
					"<?php echo $map->zoom; ?>",
					"<?php echo $map->type; ?>",
					"<?php echo $map->bike_layer; ?>",
					"<?php echo $map->traffic_layer; ?>",
					"<?php echo $map->transit_layer; ?>"
				);
			});
						...
						for (var i = 0; i < maps.length; i++) {
							...
							jQuery("#marker_pic").on("change", function () {
								...
								if (name != "") {
									...
									jQuery('#marker_pic_name').val(name);
								}
							})
