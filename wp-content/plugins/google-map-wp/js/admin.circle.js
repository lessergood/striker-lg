...
jQuery(document).ready(function () {
    loadCircleMap(
        circle_l10n.map.id,
        circle_l10n.map.styling_hue,
        circle_l10n.map.styling_saturation,
        circle_l10n.map.styling_lightness,
        circle_l10n.map.styling_gamma,
        circle_l10n.map.zoom,
        circle_l10n.map.type,
        circle_l10n.map.bike_layer,
        circle_l10n.map.traffic_layer,
        circle_l10n.map.transit_layer
    );
});
                ...
                jQuery(".edit_circle_list_delete a").on("click", function () {
                    ...
                    for (var j = 0; j < circles.length; j++) {
                        ...
                        if (circleid == id) {
                            ...
                            google.maps.event.addListener(editcircle, 'mouseover', function (event) {
                                var circle_line_color = "#" + jQuery('#hover_circle_edit_line_color').val();
                                var circle_line_opacity = jQuery('#hover_circle_edit_line_opacity').val();
                                var circle_fill_color = "#" + jQuery('#hover_circle_edit_fill_color').val();
                                var circle_fill_opacity = jQuery('#hover_circle_edit_fill_opacity').val();
                            ...
                            google.maps.event.addListener(editcircle, 'mouseout', function (event) {
                                var circle_line_color = "#" + jQuery('#circle_edit_line_color').val();
                                var circle_line_opacity = jQuery('#circle_edit_line_opacity').val();
                                var circle_fill_color = "#" + jQuery('#circle_edit_fill_color').val();
                                var circle_fill_opacity = jQuery('#circle_edit_fill_opacity').val();
                                if (editcircle) {
                                    editcircle.setOptions({
                                        strokeColor: circle_line_color,
                                        strokeOpacity: circle_line_opacity,
...
function placeCircle(location) {
    ...
    google.maps.event.addListener(newcircle, 'mouseover', function (event) {
        var circle_line_color = "#" + jQuery('#hover_circle_line_color').val();
        var circle_line_opacity = jQuery('#hover_circle_line_opacity').val();
        var circle_fill_color = "#" + jQuery('#hover_circle_fill_color').val();
        var circle_fill_opacity = jQuery('#hover_circle_fill_opacity').val();
        if (newcircle) {
            newcircle.setOptions({
                strokeColor: circle_line_color,
                strokeOpacity: circle_line_opacity,
