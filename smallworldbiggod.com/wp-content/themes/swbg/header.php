...
<div id="page" class="site">
	...
	<div class="header-image">
			<?php 
				$header_text = 'SMALL WORLD BIG GOD';
				$header_subtext = 'The need is great. He is greater still.';
				echo '<div class="header-info">
					<div class="container">';
						
						$site_logo = get_theme_mod('site_logo');
						echo '<img class="swbg-site-logo" src="' . esc_url($site_logo) . '" alt="' . esc_attr(get_bloginfo('name')) . '" />';
						echo '<h4 class="header-subtext">' . wp_kses_post($header_subtext) . '</h4>';
//echo '<h3 class="header-text">' . wp_kses_post($header_text) . '</h3>';
