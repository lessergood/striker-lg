 ...
 * Empty:  link_color
 */
generate_colors_live_update( 'header_link_color', '.site-header a, .site-header a:visited', 'color', '', 'link_color' );

/** 
 * Header link color hover
 * Empty:  link_color_hover
 */
generate_colors_live_update( 'header_link_hover_color', '.site-header a:hover', 'color', '', 'link_color_hover' );
 ...
 */
var navigation_current = '.main-navigation .main-nav ul .current-menu-item > a, \
 ...
 */
var subnavigation_current = '.main-navigation .main-nav ul ul .current-menu-item > a,\
 ...
 */
var secondary_navigation_current = '.secondary-navigation .main-nav ul .current-menu-item > a, \
	.secondary-navigation .main-nav ul .current-menu-parent > a, \
	.secondary-navigation .main-nav ul .current-menu-ancestor > a,\
	...
	.secondary-navigation .main-nav ul .current-menu-ancestor.sfHover > a';
 ...
 */
var secondary_subnavigation_current = '.secondary-navigation .main-nav ul ul .current-menu-item > a,\
	.secondary-navigation .main-nav ul ul .current-menu-parent > a, \
	.secondary-navigation .main-nav ul ul .current-menu-ancestor > a,\
	...
	.secondary-navigation .main-nav ul ul .current-menu-ancestor.sfHover > a';
