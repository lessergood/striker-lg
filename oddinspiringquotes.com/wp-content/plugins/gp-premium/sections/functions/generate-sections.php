...
include_once( '_deprecated-functions.php' );
...
function generate_sections_add_css()
{
	...
	if( '' !== $sections ) :
		...
		foreach ( $sections['sections'] as $section ) :
			...
			// Get the values
			$css = '';
			$background_color = ( isset( $section['background_color'] ) && '' !== $section['background_color'] ) ? 'background-color: ' . $section['background_color'] . ';' : '';
			$background_image = ( ! empty( $image_url[0] ) ) ? 'background-image: url(' . $image_url[0] . ');' : '';
			$text_color = ( isset( $section['text_color'] ) && '' !== $section['text_color'] ) ? 'color: ' . $section['text_color'] . ';' : '';
			$link_color = ( isset( $section['link_color'] ) && '' !== $section['link_color'] ) ? 'color: ' . $section['link_color'] . ';' : '';
			$link_color_hover = ( isset( $section['link_color_hover'] ) && '' !== $section['link_color_hover'] ) ? 'color: ' . $section['link_color_hover'] . ';' : '';
